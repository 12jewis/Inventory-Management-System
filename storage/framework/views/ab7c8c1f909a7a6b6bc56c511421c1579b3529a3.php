...
<head>
  ...
  <link href="<?php echo e(asset('backend/img/logo/logo.png')); ?>" rel="icon">
  ...
  <link href="<?php echo e(asset('backend/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css">
  <link href="<?php echo e(asset('backend/css/ruang-admin.min.css')); ?>" rel="stylesheet">
</head>
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            <div class="sidebar-brand-icon">
              <img src="<?php echo e(asset('backend/img/logo/logo2.png')); ?>">
            </div>
...
<hr class="sidebar-divider">
<div class="sidebar-heading">
  Developed By Mamun <?php echo e(date('Y')); ?>
  ...
  <div id="content">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <img class="img-profile rounded-circle" src="<?php echo e(asset('backend/img/boy.png')); ?>" style="max-width: 60px">
...
</html><?php /**PATH C:\JEWISRA\Inventory-Management-System-Laravel-SPA\resources\views/welcome.blade.php ENDPATH**/ ?>